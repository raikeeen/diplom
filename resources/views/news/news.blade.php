...
@section('title')
    <div class="container">
        ...
        <div class="row">
                <div class="col-md-7">
                    <a href="#">
                        <img class="img-fluid rounded mb-3 mb-md-0" src="{{asset('images/1234.jpg')}}" width="600" height="700" alt="">
                    </a>
                </div>
                <div class="col-md-5">
                    <h3>Активное развите маркетинговой отрасли</h3>
                    <p>Маркетинг существовал всегда – некоторые зачатки появились еще в первобытно-общинном строе. С появлением минимального избыточного продукта возникла возможность обмена между членами разных коллективов. Но развивавшийся обмен был не обменом товарами, а обменом дарами или дарообменом. Как свидетельствуют этнографические данные, суть дарообмена заключалась в создании новых или поддержании уже существовавших социальных связей между индивидами или группами. </p>
