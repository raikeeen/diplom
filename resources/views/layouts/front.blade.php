...
<body>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <nav class="navbar navbar-light">
                        ...
                        <span class="col-lg-5"><a class="navbar-brand text-white" href="">Услуги <span class="sr-only">(current)</span></a></span>
                        <div class="flex-right full-height">
                            @if (Route::has('login'))
                                <div class="top-right links">
                                    ...
                                    @else
                                        <span class="col-lg-2"><a class="navbar-brand text-white" href="{{ route('login') }}">Вход</a></span>
                                        <span class="col-lg-1"><a class="navbar-brand text-white" href="{{ route('register') }}">Регистрация</a></span>
                                    @endauth
    ...
    @if (Route::has('login'))
        @auth
        <header id="header" class="sticky_header" style="background-color: #6351ce;">
         <div class="container">
             <span class="col-lg-1"><a class="navbar-brand text-white" href="">Заявки </a></span>
